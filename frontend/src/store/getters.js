const getters = {
  ...
  classify: state => state.demo.classify,
  allStockList: state => state.demo.allStockList,
  mimeStockList: state => state.demo.mimeStockList,
  applyingList: state => state.demo.applyingList,
  allStockInList: state => state.demo.allStockInList,
  allStockOutList: state => state.demo.allStockOutList,
  process_code: state => state.demo.processCode,
  process_instance_id: state => state.demo.processInstanceId,
}
